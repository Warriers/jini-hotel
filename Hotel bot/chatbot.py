...
model = load_model('cha_model.h5')
import json
import random
intents = json.loads(open('inte.json').read())
words = pickle.load(open('wor.pkl','rb'))
classes = pickle.load(open('cla.pkl','rb'))
